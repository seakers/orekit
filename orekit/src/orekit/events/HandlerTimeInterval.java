...
public class HandlerTimeInterval implements EventHandler<AbstractDetector> {
    ...
    private final HashMap<AbsoluteDate,SpacecraftState> initialStates;
    ...
    public SpacecraftState getInitialState(AbsoluteDate date){
        return initialStates.get(date);
    }
