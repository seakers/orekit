...
public class SubScenario extends Scenario {
    ...
    public SubScenario(String name, AbsoluteDate startDate, AbsoluteDate endDate, TimeScale timeScale, Frame inertialFrame, PropagatorFactory propagatorFactory, boolean saveAllAccesses) {
        super(name, startDate, endDate, timeScale, inertialFrame, propagatorFactory, saveAllAccesses, 1);
    }

    public SubScenario(String name, AbsoluteDate startDate, AbsoluteDate endDate, TimeScale timeScale, Frame inertialFrame, PropagatorFactory propagatorFactory, boolean saveAllAccesses, CoverageDefinition covdef) {
        this(name, startDate, endDate, timeScale, inertialFrame, propagatorFactory, saveAllAccesses);
