...
public class Overlap_sequel {
    ...
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("./src/test/resources/repeat_orbits_nonSSO_varinc.csv"))) {
            String line;
...
//        }
        double alt = 890.6;
        double inc = 77.6;
        double durationDays = 0.1;
        double result = coverageGivenAltInc(alt,inc,durationDays);
        System.out.println(result);
        try{
            FileWriter csvWriter = new FileWriter("./src/test/output/varinc_results_10_1.csv");
