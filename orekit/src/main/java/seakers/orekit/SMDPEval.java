...
public class SMDPEval {
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("D:\\Documents\\VASSAR\\orekit\\CloudGrid_Nov.csv"))) { // CHANGE THIS FOR YOUR IMPLEMENTATION
            String line;
        ...
        results = forwardSearch(new SatelliteState(0,0,initialImages),6,0.995,accessLibrary,rewardGrid,actualRewardGrid);
    ...
    public static ArrayList<StateAction> forwardSearch(SatelliteState initialState, int dSolve, double gamma, HashMap<double[],GeodeticPoint> accessLibrary,HashMap<GeodeticPoint,Double> rewardGrid,HashMap<GeodeticPoint,Double> actualRewardGrid) {
        ...
        while(value != Double.NEGATIVE_INFINITY) {
            ...
            totalScore = totalScore + finalRewardFunction(newSatelliteState,res.getA(),gamma,actualRewardGrid);
