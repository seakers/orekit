...
//                GSAccessAnalyser accessTimes = new GSAccessAnalyser(events.getAllAccesses(),startDate,endDate,false, GSAccessAnalyser.Strategy.CONSERVATIVE, GndStationNetwork.GSNetwork.NEN);
...
//                GSAccessAnalyser accessTimesCL = new GSAccessAnalyser(events.getAllAccesses(),startDate,endDate,true, GSAccessAnalyser.Strategy.CONSERVATIVE, GndStationNetwork.GSNetwork.NEN);
