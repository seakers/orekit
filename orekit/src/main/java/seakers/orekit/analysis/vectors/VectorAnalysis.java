 ...
 * The vector must be accessible from the spacecraft state.
 *
 * @author nozomihitomi
 */
public abstract class VectorAnalysis extends AbstractSpacecraftAnalysis<String> {
     ...
     * @param frame
     */
    public VectorAnalysis(AbsoluteDate startDate, AbsoluteDate endDate,
