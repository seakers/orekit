...
//        gndNetworkNames.put(gndStationsNEN,"NEN");
        ...
        for(HashSet gndNetwork : gndNetworks){
            ...
            for(Constellation cons : constellations){
                ...
                GSAccessAnalyser accessTimes = new GSAccessAnalyser(events.getAllAccesses(),startDate,endDate,false);
                ...
                GSAccessAnalyser accessTimesCL = new GSAccessAnalyser(events.getAllAccesses(),startDate,endDate,true);
                ...
                HashMap<Satellite, DescriptiveStatistics> latencyPlanStats = accessTimes.getLatency();
                ...
                HashMap<Satellite, DescriptiveStatistics> latencyPlanCLStats = accessTimesCL.getLatency();
