...
for exp_i = 1:size(experiments, 1)
    ...
    nadPoint = org.orekit.attitudes.NadirPointing(inertialFrame, earthShape);
    ...
    for i=1:nsats
        ...
        if isempty(files)
            ...
            sat = orekit.object.Satellite(sprintf('sat%d',i), initial_orbit, nadPoint);
            inst =   orekit.object.Instrument(sprintf('view%d',i), ...
                orekit.object.fieldofview.RectangularFieldOfView(...
